DELETE
FROM AD_JOIN_HISTORY;
DELETE
FROM AD_INFO;
DELETE
FROM USER_INFO;

INSERT INTO AD_INFO (AD_ID, AD_NAME, AD_DESCRIPTION, AD_REWARD_AMOUNT, AD_REMAINING_COUNT, AD_IMAGE_URL, START_DATE,
                     END_DATE)
VALUES ('ad1', '광고1', '설명 1', 100, 5, 'https://example.com/image1.jpg', '2025-02-21 00:00:00', '2025-03-21 23:59:59'),
       ...
       ('ad10', '광고10', '설명 10', 160, 2, 'https://example.com/image10.jpg', '2025-03-02 00:00:00',
        '2025-03-30 23:59:59');
...
INSERT INTO AD_JOIN_HISTORY (USER_ID, AD_ID, JOIN_AT, AD_NAME, REWARD_AMOUNT)
VALUES ('user1', 'ad2', '2025-02-25 12:00:00', '광고2', 200),
...
-- USER_INFO 테이블에 1부터 110까지 유저 생성
INSERT INTO USER_INFO (USER_ID, USER_REMAINING_COUNT)
VALUES ('user1', FLOOR(RAND() * 15) + 1),
       ('user2', FLOOR(RAND() * 15) + 1),
       ('user3', FLOOR(RAND() * 15) + 1),
       ('user4', FLOOR(RAND() * 15) + 1),
       ('user5', FLOOR(RAND() * 15) + 1),
       ('user6', FLOOR(RAND() * 15) + 1),
       ('user7', FLOOR(RAND() * 15) + 1),
       ('user8', FLOOR(RAND() * 15) + 1),
       ('user9', FLOOR(RAND() * 15) + 1),
       ('user10', FLOOR(RAND() * 15) + 1);

-- 10명의 테스트 유저 추가
INSERT INTO USER_INFO (USER_ID, USER_REMAINING_COUNT)
SELECT 'user' || X,
       FLOOR(RAND() * 15) + 1
FROM SYSTEM_RANGE(11, 110) AS T(X);


INSERT INTO POLICY (ad_id, policy_type, policy_value)
VALUES ('ad6', 'MINIMUM_JOIN', 3),
       ('ad5', 'FIRST_TIME_ONLY', NULL),
       ('ad4', 'ALREADY_JOINED_AD', NULL);
